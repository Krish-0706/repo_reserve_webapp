    ...
    <>
      <style>{`
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .dash-nav-item { display: flex; align-items: center; gap: 10px; padding: 10px 12px; border-radius: 8px; font-size: 13px; color: rgba(240,237,232,0.45); cursor: pointer; transition: all 0.15s; border: none; background: none; width: 100%; text-align: left; }
      ...
      <div className="dash-root">
        <aside className="dash-sidebar">
          ...
          <button className="dash-nav-item active">
            <span style={{width:6,height:6,borderRadius:"50%",background:"#E8450A",flexShrink:0}}/>
            Dashboard
          </button>
        ...
        <main className="dash-main">
          ...
          <div className="coming-soon-card">
            ...
            <div className="coming-soon-body">Post surplus food with photo, quantity, food type, and pickup windows.<br />This module is under active development.</div>
          </div>
        </main>
      </div>
    </>
