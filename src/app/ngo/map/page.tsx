      ...
      <div className="dash-root">
        <aside className="dash-sidebar">
          ...
          <button className="dash-nav-item active">
            <span style={{width:6,height:6,borderRadius:"50%",background:"#E8450A",flexShrink:0}}/>Live Map
          </button>
          <button className="dash-nav-item">
            <span style={{width:6,height:6,borderRadius:"50%",background:"currentColor",flexShrink:0}}/>Active Pickups
          </button>
          <button className="dash-nav-item">
            <span style={{width:6,height:6,borderRadius:"50%",background:"currentColor",flexShrink:0}}/>Impact Report
          </button>
        ...
        <main className="dash-main">
          ...
          <div className="coming-soon-card">
            ...
            <div className="coming-soon-body">Live Google Maps view with real-time listing pins.<br />Claim pickups with one tap and assign volunteers instantly.</div>
          </div>
        </main>
      </div>
    </>
